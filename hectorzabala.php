...
$dato = "http://globalinvestment.com.ve/qrcoatings/hectorzabala.html";
$pngfile = 'qr_coatings_hectorzabala.png';
$nivelCorreccion = QR_ECLEVEL_H;
$tamano = 5;
...
imagecolorset($im, $indexNegro, $codeR, $codeG, $codeB);     // 
imagecolorset($im, $indexBlanco, $fondoR, $fondoG, $fondoB); // 
